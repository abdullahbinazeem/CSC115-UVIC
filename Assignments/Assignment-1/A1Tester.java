...
public class A1Tester {
	...
	public static void main(String[] args) {
		...
		x1 * The printArrays method have been completed for you.
		 */
		printArrayExample();
		testSumArray();
	...
	public static void testGreatestCommonDenominator() {
		...
		System.out.println("Testing greatestCommonDenominator(6,4)");
		result = A1Exercises.greatestCommonDenominator(6, 4);
		expected = 2;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		System.out.println("Testing greatestCommonDenominator(12,36)");
		result = A1Exercises.greatestCommonDenominator(12, 36);
		expected = 12;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		System.out.println("Testing greatestCommonDenominator(26,42)");
		result = A1Exercises.greatestCommonDenominator(26, 42);
		expected = 2;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
